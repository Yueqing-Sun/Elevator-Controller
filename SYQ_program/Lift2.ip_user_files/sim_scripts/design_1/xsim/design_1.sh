...
xv_path="D:/Applaction/Vivado/2017.1"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L util_vector_logic_v2_0_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Applaction/Vivado/2017.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
